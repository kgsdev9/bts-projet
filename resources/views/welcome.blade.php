...
@section('content')
        ...
        <div id="bootcarousel" class="carousel slide animate_text" data-ride="carousel">
            ...
            <div class="carousel-inner text-light">
                <div class="item active">
                    <div class="box-table bg-fixed shadow dark" style="background-image: url(ressources/img/2440x1578.png);">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            <h1 data-animation="animated fadeInUp">Bienvenue Sur Insittut Roosvelet  <span>Profitez-en!</span></h1>
                                            <p data-animation="animated fadeInUp">
                                              institut roosvelet est une ecole d'excellente qui a plusieurs filliale dont la principale est situé à Abidjan cote d'ivoire
                                            </p>
                ...
                <div class="item">
                    <div class="box-table shadow bg-fixed dark" style="background-image: url(ressources/img/2440x1578.png);">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            <h1 data-animation="animated fadeInUp">Postuler pour  <span>Candidature</span> BTS à 12000FCFA</h1>
                                            <p data-animation="animated fadeInUp">
                                             Profitez d'une candidature Libre BTS à un prix Abordable 
                                            </p>
                                            <a data-animation="animated fadeInDown" class="btn circle btn-light effect btn-md" href="#">Plus De Detail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            <h1 data-animation="animated fadeInUp">Une Formation  <span>D'Excellence</span></h1>
                                            <p data-animation="animated fadeInUp">
                                             Avec institut roosvelet profitez d'une formation d'excellence avec des meilleurs enseingants
                                            </p>
                                            <a data-animation="animated fadeInDown" class="btn circle btn-light effect btn-md" href="#">Consulter Nos Rubriques</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            <h1 data-animation="animated fadeInUp">TEST DESCRIPTION<span>D'Excellence</span></h1>
                                            <p data-animation="animated fadeInUp">
                                             Avec institut roosvelet profitez d'une formation d'excellence avec des meilleurs enseingants
                                            </p>
                                            <a data-animation="animated fadeInDown" class="btn circle btn-light effect btn-md" href="#">Consulter Nos Rubriques</a>
                ...
                <div class="col-md-8 our-feature-items">
                    <div class="row">
                        ...
                        <div class="col-md-12 info less-bar">
                            <h5>Introduction</h5>
                            <h1>Welcome to the beigest online learning source of examin</h1>
                            <p>
                                Alteration literature to or an sympathize mr imprudence. Of is ferrars subject as enjoyed or tedious cottage. Procuring as in resembled by in agreeable. Next long no gave mr eyes. Admiration advantages no he celebrated so pianoforte unreserved. Not its herself forming charmed amiable. Him why feebly expect future now. Resolution diminution conviction so mr at unpleasing simplicity no. No it as breakfast up conveying earnestly immediate principle. Him son disposed produced humoured overcame she bachelor improved. Studied however out wishing but inhabit fortune windows.
                            </p>
                            <p>
                                Curiosity incommode now led smallness allowance. Favour bed assure son things yet. She consisted consulted elsewhere happiness disposing household any old the. Widow downs In no impression assistance contrasted. Manners she wishing justice hastily new anxious. At discovery discourse departure objection we. Few extensive add delighted tolerably sincerity her. Law ought him least enjoy decay one quick court. Expect warmly its tended garden him esteem had remove off. Effects dearest staying now sixteen nor improve. Delightful unreserved impossible few estimating men favourable see entreaties. She propriety immediate was improving.
                            </p>
                        </div>
                ...
                <div class="col-md-4 home-sidebar">
                    ...
                    <div class="sidebar-item latest-posts trending-courses-box">
                        ...
                        <div class="trending-courses-items">
                            <div class="item">
                                <h4>
                                    <a href="#">Profession paython learing with earning skill</a>
                                </h4>
                                <div class="meta">
                                    <i class="fas fa-user"></i> By <a href="#">Drup Paul</a> 
                                    <span><i class="fas fa-clock"></i> 12 Dec, 2018</span>
                                </div>
                            </div>
                            <div class="item">
                                <h4>
                                    <a href="#">Training Industry Conference & Expo</a>
                                </h4>
                                <div class="meta">
                                    <i class="fas fa-user"></i> By <a href="#">Drup Paul</a> 
                                    <span><i class="fas fa-clock"></i> 25 Nov, 2018</span>
                                </div>
                            </div>
                            <div class="item">
                                <h4>
                                    <a href="#">Advertising and Content Marketing</a>
                                </h4>
                                <div class="meta">
                                    <i class="fas fa-user"></i> By <a href="#">Drup Paul</a> 
                                    <span><i class="fas fa-clock"></i> 13 Jan, 2019</span>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="popular-courses-items bottom-price popular-courses-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="ressources/img/800x600.png" alt="Thumb">
                                </a>
                                <div class="overlay">
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="ressources/img/100x100.png" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
            ...
            <div class="row">
                <div class="top-cat-items">
                    <div class="col-md-3 col-sm-6 equal-height">
                        <div class="item" style="background-image: url(ressources/img/800x600.png);">
                            <a href="#">
                ...
                <div class="col-md-12">
                    <div class="advisor-carousel owl-carousel owl-theme text-center text-light">
                        ...
                        <div class="advisor-item">
                            <div class="info-box">
                                <img src="ressources/img/800x800.png" alt="Thumb">  
    ...
    <!-- Start Video Area
    ============================================= -->
    <div class="video-area padding-xl text-center bg-fixed text-light shadow dark-hard" style="background-image: url(ressources/img/2440x1578.png);">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                <div class="event-items">
                    ...
                    <div class="item horizontal col-md-12">
                        <div class="col-md-6 thumb bg-cover" style="background-image: url(ressources/img/1500x700.png);">
                            <div class="date">
            ...
            <div class="row">
                <div class="blog-items">
                    ...
                    <div class="col-md-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="ressources/img/800x600.png" alt="Thumb"></a>
                                <div class="date">
    ...
    <!-- Start Subscribe 
    ============================================= -->
    <div class="subscribe-area text-center text-light default-padding bg-fixed shadow dark-hard" style="background-image: url(ressources/img/2440x1578.png);">
        <div class="container">
            <div class="row">

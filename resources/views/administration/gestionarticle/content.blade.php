...
@section('admin')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="compose.html" class="btn btn-primary btn-block margin-bottom">Administration Article</a>
          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <div class="pull-right">
                <button type="button" class="btn btn-default"><i class="fa fa-reply"></i> Liste Article</button>
                <button type="button" class="btn btn-default"><i class="fa fa-share"></i>Accueil</button>
              </div>

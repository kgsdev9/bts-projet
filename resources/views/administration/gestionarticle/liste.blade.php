              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                 ...
                 <tr>
                    ...
                    <td class="mailbox-name"><a href="{{route('content.article', $article->id)}}">{{$article->user->name}}</a></td>
                    <td class="mailbox-subject"><b>{{$article->name_article}}</b> - {{Str::limit( $article->description, 30)}}
                    </td>

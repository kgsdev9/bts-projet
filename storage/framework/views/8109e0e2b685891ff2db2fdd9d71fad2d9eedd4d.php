                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="content">
                                            ...
                                            <a data-animation="animated fadeInDown" class="btn circle btn-light effect btn-md" href="<?php echo e(route('ajout_candidature')); ?>">Plus De Detail</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="popular-courses-items bottom-price popular-courses-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="<?php echo e(route('content.index', $c->id)); ?>">
                                    <img src="<?php echo e(asset('uploads/articles/'. $c->image)); ?>" alt="Thumb" style="height:300px; width:849px;">
                                </a>
                                <div class="overlay">
                                    <a class="btn btn-theme effect btn-sm" href="<?php echo e(route('content.index', $c->id)); ?>">
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?php echo e(asset('ressources/img/logo.png')); ?>" alt="Thumb" ></a>
                                    </div>
                                    <div class="others">
                                ...
                                <h4><a href="#"><?php echo e(Str::limit($c->name_article, 55)); ?></a></h4>
                                <div class="cats">
                                    <a href="#"> <?php echo e($c->category->name); ?>Education</a>

                                </div>
                                <p>
                                        <?php echo e(Str::limit($c->description, 100)); ?>
                    ...
                    <div class="clients-review-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="col-md-5 thumb">
                                <img src="<?php echo e(asset('ressources/img/logo.png')); ?>" alt="Thumb">
                            </div>
...
<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bts\resources\views/welcome.blade.php ENDPATH**/ ?>